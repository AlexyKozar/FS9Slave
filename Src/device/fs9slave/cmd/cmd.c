...
cmd_t cmd_list[MAX_CMD_NUM] =
{
    ...
    { 2, 2, true },
    { 2, 2, true },
    { 2, 2, false }, // чтение байта конфигурации искробезопасных входов
    { 3, 2, true }, // запись байта конфигурации искробезопасных входов
    { 2, 2, true },
    { 2, 2, true },
    { 3, 10, false },
    { 11, 2, false },
    ...
    { 0, 0, false },
    { 0, 0, false },
    { 2, 17, false }, // чтение отладочной информации (счетчиков ошибок)
    { 2, 9, false }, // a device data (id, number, lot, firmware variant and firmware date - 3 bytes)
    { 2, 4, false }, // чтение времени срабатывания выделенного входного дискретного канала
    { 0, 0, false },
    { 0, 0, false },
    { 0, 0, false },
    { 0, 0, false },
    ...
    { 0, 0, false },
    { 0, 0, false },
    { 2, 2, true }, // чтение из памяти (тест eeprom)
