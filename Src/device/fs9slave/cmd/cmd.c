...
cmd_t cmd_list[MAX_CMD_NUM] =
{
    ...
    { 3, 2, true },     // 0x19 - запись байта конфигурации искробезопасных входов
    { 0, 0, false },     // 0x1A
    { 0, 0, false },     // 0x1B
    { 0, 0, false },     // 0x1C
    ...
    { 0, 0, false },     // 0x38
    { 0, 0, false },     // 0x39
    { 14, 2, true },     // 0x3A - запись нового серийного номера
    { 0, 0, false },     // 0x3B
    { 0, 0, false },     // 0x3C
    { 0, 0, false },     // 0x3D
    { 5, 2, true },      // 0x3E - установка параметров фильтрации (кол-во периодов, дискретность, сигнал в мс)
    { 7, 2, true }       // 0x3F - настройка входа по его номеру или группы входов (признак - старший бит в списке номеров)
};
//-------------------------
